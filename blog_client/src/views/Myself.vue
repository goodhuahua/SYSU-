<template>
  <div>
    ...
    <div class="card">
      ...
      <div style="position: absolute; top: 25px; left: 200px; font-size: 20px">
        {{ user.name }}
      </div>
      <div style="position: absolute; top: 70px; left: 200px">
        ...
        <text style="font-weight: bold; font-size: 20px; margin-left: 20px">{{
          user.fans
        }}</text>
    ...
    <n-modal v-model:show="showAvatarModal">
      <div style="width: 600px; height: 320px; background: white">
        ...
        <div style="position: absolute; right: 90px; bottom: 20px">
          <n-button type="default" @click="closeAvatarModal"> 取消 </n-button>
        </div>
    ...
    <n-modal v-model:show="showNameModal">
      <div style="width: 440px; height: 185px; background: white">
        ...
        <div style="position: absolute; right: 90px; bottom: 20px">
          <n-button type="default" @click="closeNameModal"> 取消 </n-button>
        </div>
        <div style="position: absolute; right: 20px; bottom: 20px">
          <n-button type="primary" @click="modifyName"> 确认 </n-button>
        </div>
      </div>
    </n-modal>
        ...
        <n-tabs type="line">
          ...
          <n-tab-pane name="following" tab="我的关注">
            <div v-for="(fol, index) in following" style="margin-bottom: 15px">
              <n-card>
                <n-avatar
                  @click="toOtherUser(fol)"
                  round
                  size="large"
                  :src="serverUrl + fol.avatar"
